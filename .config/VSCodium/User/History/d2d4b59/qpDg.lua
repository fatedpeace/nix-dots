...
-- Increase volume with Ctrl + Alt + ] (Press-and-hold repeating enabled)
hl.bind("CTRL + ALT + bracketright", hl.dsp.exec_cmd("wpctl set-volume -l 1.0 @DEFAULT_AUDIO_SINK@ 5%+"), { repeating = true })
-- Decrease volume with Ctrl + Alt + [ (Press-and-hold repeating enabled)
hl.bind("CTRL + ALT + bracketleft", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-"), { repeating = true })
