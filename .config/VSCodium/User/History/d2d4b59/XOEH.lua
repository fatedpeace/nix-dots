...
-- Increase volume with Ctrl + Alt + ]
hyprland.bindel({ "CTRL_ALT", "bracketright", "exec wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 5%+" })

-- Decrease volume with Ctrl + Alt + [
hyprland.bindel({ "CTRL_ALT", "bracketleft", "exec wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-" })
