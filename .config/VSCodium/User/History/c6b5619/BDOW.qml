...
PanelWindow{ // the parent, outter most
    ...
    implicitHeight: island.height + 8 // the space reserved for the island to be automatically the height of the island
    ...
    Rectangle { // the child insde the parent
        ...
        y: islandVisible ? 8 : -60 // dectects the value for the property islandVisibile and if true it sets y = 0 and if false it sets it to y = -60
    }
}