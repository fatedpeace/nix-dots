...
PanelWindow{ // the parent, outter most
    ...
    implicitWidth: 350 // the space reserved for the island to be automatically the width of the island
    ...
    Rectangle { // the child insde the parent
        ...
        height: 45 // height for rectangle
