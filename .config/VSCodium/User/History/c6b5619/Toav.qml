...
PanelWindow{ // the parent, outter most
    ...
    implicitHeight: island.height + 10 // the space reserved for the island to be automatically the height of the island the plus 8 is to adjust for the 8px margins
