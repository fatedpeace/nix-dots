...
PanelWindow {
    ...
    // Invisible area used as the top-edge trigger
    implicitWidth: 1920
    implicitHeight: 80
    ...
    Rectangle {
        ...
        //
        // The multiplier determines how much space each character
        // approximately receives.
        property real titleWidth:
            root.mediaTitle.length * 8

        // Expand only while media is playing.
        //
        // Never smaller than 200 and never larger than 500.
        width: {
        ...
        Row {
            ...
            // No media:
            // Time is handled separately and centered.
            //
            // Media playing:
            // Move workspace + time toward the left.
        ...
        Text {
            ...
            // Leave room for workspace + clock.
            width: Math.max(
                0,
                parent.width - 150
            )
