    ...
    Rectangle {
        ...
        Row {
            ...
            Text {
                ...
                // Emoji fonts often sit slightly too high.
                // This visually centers it with the clock.
            ...
            Text {
                ...
                // Keep exactly the font settings
        ...
        Row {
            ...
            Text {
                ...
                // Original working font settings
                font.family: root.mainFont
                font.pixelSize: 18
                font.weight: Font.DemiBold
                font.letterSpacing: 0.2
        ...
        Text {
            ...
            // Original working media font settings
            font.family: root.mainFont
            font.pixelSize: 17
